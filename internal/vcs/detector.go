...
func (g GitVCS) ExtractFileDiff(diffText, targetPath string) string          { return git.ExtractFileDiff(diffText, targetPath) }
...
func (h HgVCS) ExtractFileDiff(diffText, targetPath string) string           { return hg.ExtractFileDiff(diffText, targetPath) }
